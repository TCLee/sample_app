...
describe UsersController do
  ...
  describe "GET 'index'" do
    ...
    describe "for non-admin users" do
      before :each do 
        @not_admin = Factory(:user, :admin => false)
        test_sign_in(@not_admin)
      end

      it "should not show delete links" do
        get :index
        response.should_not have_selector("a", :href => user_path(@not_admin), 
                                               :content => "delete")                        
      end
    end          
  ...
  describe "GET 'show'" do
    ...
    it "should find the the right user" do
      get :show, :id => @user
  ...
  describe "POST 'create'" do
    ...
    describe "failure" do
      ...
      # Verify that a failed 'create' action does NOT create a user in the database.
  ...
  describe "follow pages" do
    ...
    describe "when signed in" do
      ...
      it "should show user's followers" do
